...
public class ColorProfileService
{
    ...
    public bool AddDisplayColorProfile(string displayName, string profileName, bool setAsDefault = true)
    {
        return CCD.AddDisplayColorProfile(displayName, profileName, setAsDefault);
    }


    public bool RemoveDisplayColorProfile(string displayName, string profileName)
    {
        return CCD.RemoveDisplayColorProfile(displayName, profileName);
    }

    public bool SetDisplayDefaultColorProfile(string displayName, string profileName, bool fixMaxTML = true)
    {
        return CCD.SetDisplayDefaultColorProfile(displayName, profileName, fixMaxTML);
    }

    public string GetDisplayDefaultColorProfile(string displayName, COLORPROFILESUBTYPE profileSubType = COLORPROFILESUBTYPE.CPST_STANDARD_DISPLAY_COLOR_MODE)
    {
        return CCD.GetDisplayDefaultColorProfile(displayName, profileSubType);
    }
    ...
    public ColorProfileDto GetColorProfile(string name)
    {
        var data = MHC2Wrapper.LoadProfile(name, true);
    ...
    public bool UpdateColorProfile(ColorProfileDto colorProfile, string displayName = null)
    {
        ...
        {
            CCD.AddDisplayColorProfile(displayName, colorProfile.Name, false);
        }
    ...
    public bool InstallAndActivateColorProfile(ColorProfileDto colorProfile, string displayName)
    {
        ...
        return CCD.SetDisplayDefaultColorProfile(displayName, profileName, true);
    }
    ...
    public List<DisplayInfoDto> GetDisplayInfos(bool? onlyHdrEnabled = null)
    {
        return Display.GetDisplays().Select(d =>
        {
            ...
            return new DisplayInfoDto
            {
                ...
                DefaultColorProfile = GetDisplayDefaultColorProfile(d.DisplayName, advancedColor.isEnabled ? COLORPROFILESUBTYPE.CPST_EXTENDED_DISPLAY_COLOR_MODE : COLORPROFILESUBTYPE.CPST_STANDARD_DISPLAY_COLOR_MODE)
            };
        })
