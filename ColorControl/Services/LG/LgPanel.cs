...
namespace ColorControl.Services.LG
{
    partial class LgPanel : UserControl, IModulePanel
    {
        ...
        private void clbLgPower_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            if (e.Index is 0 or 1 or 5 or 8 && !(device.PowerOnAfterResume || device.PowerOnAfterStartup || device.PowerOnAfterScreenSaver || device.PowerOnByWindows || device.PowerOnAfterSessionUnlock))
            {
                MessageForms.InfoOk(
