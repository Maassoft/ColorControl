...
public static class LgFields
{
    public static List<FieldDefinition> GetSettingsFields(LgServiceConfigDto config)
    {
        return new List<FieldDefinition>
        {
            ...
            },
            {
                new FieldDefinition
                {
                    Name = "GameBarShortcut",
                    FieldType = FieldType.Shortcut,
                    Label = "Game Bar shortcut",
                    Value = config.GameBarShortcut
                }
            },
            {
                new FieldDefinition
                {
                    Name = "GameBarShowingTime",
                    FieldType = FieldType.Numeric,
                    Label = "Game Bar showing time (milliseconds).",
                    MinValue = 1000,
                    MaxValue = 60000,
                    Value = config.GameBarShowingTime
                }
            },
            {
                new FieldDefinition
