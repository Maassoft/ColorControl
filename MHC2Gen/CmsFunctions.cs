...
public static class CmsFunctions
{
    ...
    public static double SrgbInvEotf(double luminance, double whiteLuminance, double blackLuminance, double gamma = 2.4)
    {
        ...
        var x = whiteLuminance <= blackLuminance ? 0 : (luminance - blackLuminance) / (whiteLuminance - blackLuminance);
    ...
    public static (double, double) SrgbAcm(double signalValue, double whiteLuminance, double blackLuminance = 0, double gamma = 2.2, int divider = 1023)
    {
        var b = signalValue / divider;
        var c = PqEotf(b);
    ...
    public static double Srgb(double signalValue)
    {
