...
namespace NvAPIWrapper.Native
{
    public static partial class GPUApi
    {
        ...
        public static PrivateClockBoostMasksV1 GetClockBoostMask(PhysicalGPUHandle gpuHandle)
        {
            ...
            instance._Masks = new[] { 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff };
        ...
        /// <param name="gpuHandle">The handle of the GPU to perform the operation on.</param>
        /// <returns>The GPU clock boost table.</returns>
        public static PrivateClockBoostTableV2 GetClockBoostTableV2(PhysicalGPUHandle gpuHandle)
        {
            var instance = typeof(PrivateClockBoostTableV2).Instantiate<PrivateClockBoostTableV2>();
            instance._Masks = new[] { 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff };
            ...
            using (var clockTableReference = ValueTypeReference.FromValueType(instance))
            {
                ...
                return clockTableReference.ToValueType<PrivateClockBoostTableV2>(typeof(PrivateClockBoostTableV2));
            }
        }
        ...
        public static PrivateVFPCurveV1 GetVFPCurve(PhysicalGPUHandle gpuHandle, uint[] masks)
        {
            var instance = typeof(PrivateVFPCurveV1).Instantiate<PrivateVFPCurveV1>();
            //instance._Masks = new[] { 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff };
            instance._Masks = masks;
        ...
        /// <param name="gpuHandle">The handle of the GPU to perform the operation on.</param>
        /// <returns>The retrieved VFP curve.</returns>
        public static PrivateVFPCurveV3 GetVFPCurveV3(PhysicalGPUHandle gpuHandle)
        {
            var instance = typeof(PrivateVFPCurveV3).Instantiate<PrivateVFPCurveV3>();
            instance._Masks = new[] { 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff };
            ...
            using (var vfpCurveReference = ValueTypeReference.FromValueType(instance))
            {
                ...
                return vfpCurveReference.ToValueType<PrivateVFPCurveV3>(typeof(PrivateVFPCurveV3));
            }
        }
        ...
        /// <param name="gpuHandle">The handle of the GPU to perform the operation on.</param>
        /// <param name="clockBoostTable">The new clock table.</param>
        public static void SetClockBoostTableV2(PhysicalGPUHandle gpuHandle, PrivateClockBoostTableV2 clockBoostTable)
        {
            using (var clockTableReference = ValueTypeReference.FromValueType(clockBoostTable))
            {
                var status = DelegateFactory.GetDelegate<Delegates.GPU.NvAPI_GPU_SetClockBoostTable>()(
