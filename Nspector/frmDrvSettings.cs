...
namespace nspector
{
    ...
    public partial class frmDrvSettings : Form
    {
        ...
        private bool _highlightUnexposedSettings;
        ...
        private void RefreshCurrentProfile()
        {
            ...
            try
            {
                ...
                foreach (var settingItem in _currentProfileSettingItems)
                {
                    ...
                    if (_highlightUnexposedSettings && !settingItem.IsApiExposed)
                    {
        ...
        private void SetTitleVersion()
        {
            ...
            Text = $"{Application.ProductName} {version} - NvInspector - Geforce {_drs.DriverVersion.ToString("#.00", numberFormat)} - Profile Settings - {fileVersionInfo.LegalCopyright}";
        }
        ...
        public frmDrvSettings() : this(false, false) { }
        public frmDrvSettings(bool showCsnOnly, bool skipScan)
        {
            _skipScan = skipScan;
            InitializeComponent();
            InitTaskbarList();
